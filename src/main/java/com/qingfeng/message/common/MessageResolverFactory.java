...
import com.qingfeng.message.resolver.Resolver;

import java.util.List;
import java.util.concurrent.CopyOnWriteArrayList;

public class MessageResolverFactory{ // 创建一个工厂类实例
        ...
        public Resolver getMessageResolver(Message message) {
            ...
            throw new RuntimeException("cannot find resolver, message type: " + message.getHead().getMessageType());
        }
